    ...
    <el-tabs v-model="activeName" @tab-click="clickTab">
      ...
      <el-tab-pane label="我的点赞" name="我的点赞">
        ...
        <div style="margin-top: 10px">
          ...
          <activity-list v-if="likesCurrent === '活动'" :span="8" type="like"/>
        </div>
      </el-tab-pane>
      <el-tab-pane label="我的收藏" name="我的收藏">
        ...
        <div style="margin-top: 10px">
          ...
          <activity-list v-if="collectCurrent === '活动'" :span="8" type="collect"/>
        </div>
      </el-tab-pane>
      <el-tab-pane label="我的评论" name="我的评论">
        ...
        <div style="margin-top: 10px">
          ...
          <activity-list v-if="commentCurrent === '活动'" :span="8" type="comment"/>
        </div>
      </el-tab-pane>
    </el-tabs>
    <Footer />
...
export default {
  components: {ActivityList, BlogList, PersonPage, Footer},
  data() {
